...
- [Authority and gate review](authority-and-gate-review.md): current author inspection and package verification, based on PR head `7a8063bb2c997a015a68db43ee07d9f388dc5372`. The reviewed candidate is the commit containing this update; final pushed SHA and hosted CI are recorded on [PR #1](https://github.com/Quang-Dong/project-orchestrator/pull/1).
...
| Current authority/index update; baseline `7a8063b` | [Author review](authority-and-gate-review.md) | Source/gate interpretation and package checks only; prepared behavioral cases remain unrun. |
...
| [Behavioral readiness](behavioral-readiness.md) | New prepared packets, no execution results. Worker inputs and assessor-only rubric must remain separate in any future authorized run. |
